		...
		<div class="login">
		    ...
		    <form name="loginForm" id="loginForm" method="post"> 
		        ...
		        <div class="login_btn_area">
		            ...
		            <div class="find_area">
		                <button type="button" class="" onClick="popFindId()">아이디찾기</button> / <button type="button" class="" onClick="popFindPassword()">비밀번호찾기</button>
		            </div>
		        </div> 
		    </form>
		</div>
