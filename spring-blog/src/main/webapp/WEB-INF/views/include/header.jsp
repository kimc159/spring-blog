		...
		<div class="headerInner">
			<ul class="leftMenu"> 
				<c:if test="${not empty login.memId}">
					<li><a href="/chat/chatUserFind">친구찾기</a></li>
					<li><a href="/chat/chatFriend">친구</a></li>
					<li><a href="/chat/chatRoomList">채팅</a></li>
				</c:if>
			</ul>
			<h1 class="logo"> 
				<a href="/" data-trans="블로그">블로그</a>
			</h1>
			<ul class="rightMenu">
				<c:if test="${empty login.memId}">
					<li><a href="/login" data-trans="로그인">로그인</a></li>
				...
				<c:if test="${not empty login.memId}">
					...
					<li><a href="/logout" data-trans="로그아웃">로그아웃</a></li>
				</c:if>
			</ul>
		</div>
	</div>